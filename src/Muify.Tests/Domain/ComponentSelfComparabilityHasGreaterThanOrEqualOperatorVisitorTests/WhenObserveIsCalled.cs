namespace Muify.Domain.ComponentSelfComparabilityHasGreaterThanOrEqualOperatorVisitorTests;
...
{
    [Test]
    public async Task GivenAComponentWhenSelfHasGreaterThanOrEqualOperatorIsFalseThenGreaterThanOrEqualSelfDefinitionIsGenerated()
    {
        // Arrange
        ...
        var visitor = new ComponentSelfComparabilityHasGreaterThanOrEqualOperatorVisitor();
        ...
        _ = await Assert.That(definition.Hint).IsEqualTo($"{wheel.Name}.Self.Comparison.GreaterThanOrEqual");
    }
    ...
    public async Task GivenAComponentWhenIdentifierHasGreaterThanOrEqualOperatorThenNothingIsGenerated()
    {
        ...
        Component wheel = TestData.Single.Units.Value[0].Components[1]
            .WithMetadata(metadata => metadata
                ...
                .WithSelf(self => self
                    .WithComparability(comparability => comparability
                        .HasGreaterThanOrEqualOperator(true)
                        .IsComparable(Presence.Present))));
