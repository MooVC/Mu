namespace Muify.Domain.ComponentSelfComparabilityIsComparableVisitorTests;
...
{
    [Test]
    public async Task GivenAComponentWhenSelfIsComparableIsFalseThenComparableToSelfDefinitionIsGenerated()
    {
        // Arrange
        const string expected = """
            ...
            partial class Wheel
                : global::System.IComparable<Wheel>
            {
            }
            """;

        var visitor = new ComponentSelfComparabilityIsComparableVisitor();
        ...
        _ = await Assert.That(definition.Hint).IsEqualTo($"{wheel.Name}.Self.IComparable");
    }

    [Test]
    public async Task GivenAComponentWhenSelfIsComparableIsPresentThenNothingIsGenerated()
    {
        // Arrange
        var visitor = new ComponentSelfComparabilityIsComparableVisitor();
