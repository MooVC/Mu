namespace Muify.Domain
{
    ...
    internal sealed class ComponentSelfComparabilityHasLessThanOrEqualOperatorVisitor
          ...
          IModelVisitor<Model.Graph.Areas.Area.Units.Unit.Components.Component, File>
    {
        ...
        private static IEnumerable<File> Generate(Component component, Qualifier @namespace)
        {
            if (component.Identifier.IsUndefined
             ...
             || component.Metadata.Self.Comparability.HasLessThanOrEqualOperator)
            {
                yield break;
            }
            ...
            yield return new File(content, $"{component.Name}.Self.Comparison.LessThanOrEqual");
        }
    }
}