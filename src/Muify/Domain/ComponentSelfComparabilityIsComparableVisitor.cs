namespace Muify.Domain
{
    ...
    internal sealed class ComponentSelfComparabilityIsComparableVisitor
        ...
        private static IEnumerable<File> Generate(Component component, Qualifier @namespace)
        {
            ...
            var content = Builder
                ...
                .For<Class>(@class => @class
                    .DerivesFrom((Name: $"IComparable<{component.Name}>", Qualifier: "System"))
            ...
            yield return new File(content, $"{component.Name}.Self.IComparable");
        }
    }
}